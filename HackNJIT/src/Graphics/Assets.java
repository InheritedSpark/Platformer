...
public class Assets {
	...
	public void loadgraphics(){
		...
		tiles[8] = tileSet.getSubimage(9*32, 1*32, 32, 32);	/// stone platform middle
		tiles[18] = tileSet.getSubimage(8*32, 1*32, 32, 32);	/// stone platform left
		tiles[19] = tileSet.getSubimage(10*32, 1*32, 32, 32);	/// stone platform right
