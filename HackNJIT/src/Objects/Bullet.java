...
public class Bullet extends Object {
	...
	public Line2D ray;
	private double trailVis;
	
	public Bullet(Main game, double x, double y, int width, int height, double facing,double speed, String type, int damage, int range, int pushback, double recoil, ID id, Handler handler) {
	...
	public void tick() {
		...
		if(type.equals("turret")){
			ray = new Line2D.Double(x, y, x+speed * Math.cos(facing)*game.delta, y+speed * Math.sin(facing)*game.delta);
